...
const RightHomeInfoSpace = ({ arr }) => {

    // const [gameName, setGameName] = useState('');
    // const [mintAddress, setMintAddress] = useState('');
    return (
        <div className="right_home_info_startspace">
            <div className="right_home_infospace">
                <div>
            ...
            <div className="right_home_info2space">
                <div>
...
export default RightHomeInfoSpace;